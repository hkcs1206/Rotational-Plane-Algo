    ...
    for i = 1: h
        ...
        for j = 1: k
            ...
            if draw_line == 1
                ...
                % line([node_1(1, 1), node_2(1, 1)], [node_1(1, 2), node_2(1, 2)], 'Color', 'g');
...
%init initialization process for the list S
    ...
    % line([vertices(vertex_1, 1), vertices(vertex_1, 1) + cos(0) * 20], [vertices(vertex_1, 2), vertices(vertex_1, 2) + sin(0) * 20], 'Color', 'g');
...
%calculate_distance calculate the distance between one point to the line segment
    ...
    % distance = abs(((y_2 - y_1) * x_0) - ((x_2 - x_1) * y_0) + (x_2 * y_1) - (y_2 * x_1)) / sqrt((y_2 - y_1)^2 + (x_2 - x_1)^2);
